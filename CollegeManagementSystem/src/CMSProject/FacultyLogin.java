...
public class FacultyLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CMSProject/FacultyImagee.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "select * from facultyregistertb where FacultyUserName=? and FacultyId=?";
        try
        {
            ...
            if(rs.next())
            {
                ...
                new FacultyDashboard(username).setVisible(true);
            }
            else
            {
