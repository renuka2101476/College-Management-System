...
public class StudentLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CMSProject/StudentImag.jpg"))); // NOI18N
        ...
        jLabel8.setText("If you are New Student...");

        jLabel9.setForeground(new java.awt.Color(51, 51, 255));
        jLabel9.setText("Addmission");
        ...
        jLabel11.setText("then, please take a ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "select * from studentadmission where StudentUserName=? and EnrollmentNo=?";
        try
        {
            ...
            if(rs.next())
            {
                ...
                //String username = jTextField1.getText();
                //StudentDashboard dashboard = new StudentDashboard(username); // Pass the username to the StudentDashboard constructor
